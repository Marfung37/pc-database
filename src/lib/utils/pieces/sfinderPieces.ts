 ...
 */
export function parsePattern(pattern: string): (GeneratorLiteral | FilterBlock)[][][] {
 ...
 */
export function sfinderPieces(parsedPattern: (GeneratorLiteral | FilterBlock)[][][]): string[] {
...
export function randomSfinderPieces(
  parsedPattern: (GeneratorLiteral | FilterBlock)[][][],
