...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      statistics: {
        Row: {
          ...
          path_file: boolean;
          setup_id: string;
          solve_fraction: Database['public']['CompositeTypes']['unsafe_fraction'] | null;
    ...
    Functions: {
      ...
      all_decimals_lte_100: { Args: { arr: number[] }; Returns: boolean };
      auth_hook_add_user_info: { Args: { event: Json }; Returns: Json };
      delete_set_edge: {
        Args: { child_id: number; parent_id: number };
        Returns: undefined;
      };
      ...
      has_edit_permission: { Args: never; Returns: boolean };
      is_valid_fraction_array: { Args: { arr: unknown[] }; Returns: boolean };
      print_oqb_as_dot: { Args: { start_path?: unknown }; Returns: string };
      print_sets_as_dot: { Args: { start_path?: unknown }; Returns: string };
    };
    Enums: {
      hold_type: 'any' | 'cyclic' | 'none';
      kicktable: 'srs' | 'srs_plus' | 'srsx' | 'srs180' | 'tetrax' | 'asc' | 'ars' | 'none';
